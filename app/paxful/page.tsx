  ...
  return (
   //paxfull login page
    <main className="flex items-center  content-evenly ">
        <div className="flex flex-col items-start justify-center w-full max-w-md p-2 lg:ml-10 mx-auto mt-16 bg-white ">
            ...
            <div className="flex flex-col gap-4 mt-6 justify-start w-full items-start">
                ...
                <div className="flex flex-col justify-start w-full items-start space-y-2">
                    ...
                    <input type="password" className="w-full border focus:border-[#42a4d1] outline-none rounded-sm p-2 " />
                </div>

                <button className="w-full bg-[#00A5EF] hover:bg-[#42a4d1] flex items-center justify-between text-white rounded-sm p-4 mt-2">
                    Log In
